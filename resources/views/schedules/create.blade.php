            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ isset($schedule) ? route('schedules.update', $schedule) : route('schedules.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="scheduled_time" name="scheduled_time" type="time" value="{{ old('scheduled_time', $schedule->scheduled_time ?? '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required />
